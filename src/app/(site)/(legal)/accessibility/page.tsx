...
export default function AccessibilityPage() {
  return (
    <>
      ...
      <H3 as="h2" className="font-bold">Standards</H3>
      <P1>
      ...
      <H3 as="h2" className="font-bold">Measures we take</H3>
      <P1>
      ...
      <H3 as="h2" className="font-bold">Limitations</H3>
      <P1>
      ...
      <H3 as="h2" className="font-bold">Feedback</H3>
      <P1>
