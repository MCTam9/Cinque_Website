...
export default function TermsPage() {
  return (
    <>
      ...
      <H3 as="h2" className="font-bold">Orders &amp; contract</H3>
      <P1>
      ...
      <H3 as="h2" className="font-bold">Intellectual property</H3>
      <P1>
      ...
      <H3 as="h2" className="font-bold">Liability</H3>
      <P1>
      ...
      <H3 as="h2" className="font-bold">Governing law</H3>
      <P1>
